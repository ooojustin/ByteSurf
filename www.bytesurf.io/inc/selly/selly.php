<?php
    ...
    define('SELLY_RETURN_URL', 'https://bytesurf.io/login/'); // url to return to after completed purchase
    define('SELLY_WEBHOOK_URL', 'https://bytesurf.io/inc/selly/webhook.php?invoice='); // append invoice id to the end of this string
