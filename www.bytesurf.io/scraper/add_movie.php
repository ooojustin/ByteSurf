<?php
    ...
    $subtitles = json_encode($data['subs']);
    $imdb_id = $data['imdb_id'];
    $year = $data['year'];
    $certification = $data['certification'];
    $rating = $data['rating'];

    $updateTable = $db->prepare("INSERT INTO movies (title, url, description, duration, thumbnail, preview, qualities, genres, imdb_id, rating, year, subtitles, certification) VALUES (:title, :url, :description, :duration, :thumbnail, :preview, :qualities, :genres, :imdb_id, :rating, :year, :subtitles, :certification);");
    ...
    $updateTable->bindValue(':subtitles', $subtitles);
