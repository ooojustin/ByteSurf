    ...
    */
    ...
    for ($i = $start_index; $i <= $end_index; $i++) {
    	...
    	$response = send_email(
    		...
    		'mailer@bytesurf.io', // email to send from
    		'ByteSurf Mailer', // name to send from
    		$email, // email to send to
    		'ByteSurf Customer' // name to send to
    	);
    ...
    if ($done) {
        ...
        $url = 'https://bytesurf.io/admin/mailer.php?post=' . $_GET['post'];
